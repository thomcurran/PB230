...
We could test this more formally, as we did for ANOVA. But regression is robust to small deviations in normality and, besides, our sample is so large it will invariably turn a significant result. No need here. The residuals look pretty symmetrical.
