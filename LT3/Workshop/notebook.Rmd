...
3. Kaiser’s (1960) stopping rule.  Extract only factors with	an eigenvalue of  1 or more. An eignenvalue is variance explained, the sum of squares for the factor.
